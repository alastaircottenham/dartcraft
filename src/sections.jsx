...
const FAQ = () => {
  const faqs = [
    ...
    {q:'Can I set this up outdoors?', a:"Yes, but with some caveats. The system needs to be in a sheltered, weatherproof area — protected from rain, wind, and direct exposure to the elements. Outdoors, natural light is the bigger challenge: shifting sunlight throughout the day can affect how reliably the cameras detect and read darts. At night, with consistent artificial lighting, the system performs much more predictably. So while outdoor installs are possible, a covered space and evening play will give you the best experience."},
    ...
    {q:'Can I pick up locally in Perth?', a:"At this time, all orders are shipped within Australia and local pickup isn't available."},
    ...
    {q:'What mini PC is included in the full system?', a:"The full system includes a refurbished mini PC — typically a Dell OptiPlex Micro or equivalent — with an Intel i5 processor and 8GB of RAM. Each unit is tested and configured for AutoDarts before dispatch. The exact model may vary based on availability, but every PC we include is specifically selected to ensure reliable, smooth performance."},
    ...
    {q:'Is support included?', a:"Every order includes a detailed setup guide covering installation, calibration and common fixes. DartCraft doesn't offer ongoing technical support, but the AutoDarts community is active and helpful. If you receive faulty hardware, get in touch and we'll sort it out."},
